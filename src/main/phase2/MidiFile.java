...
//		static final int SEMIBREVE = 64;
		...
		mf.noteOnOffNow (length1, 60, 127);
		mf.noteOnOffNow (length1, 62, 127);
		mf.noteOnOffNow (length1, 64, 127);
		mf.noteOnOffNow (length1, 65, 127);
		mf.noteOnOffNow (length1, 67, 127);
		mf.noteOnOffNow (length1, 69, 127);
		mf.noteOnOffNow (length1, 71, 127);
		mf.noteOnOffNow (length1, 72, 127);
		
		
		mf.noteOnOffNow (length2, 60, 127);
		mf.noteOnOffNow (length2, 62, 127);
		mf.noteOnOffNow (length2, 64, 127);
		mf.noteOnOffNow (length2, 65, 127);
		mf.noteOnOffNow (length2, 67, 127);
		mf.noteOnOffNow (length2, 69, 127);
		mf.noteOnOffNow (length2, 71, 127);
		mf.noteOnOffNow (length2, 72, 127);
//
//		mf.noteOnOffNow (MINIM, 60, 50);
//		mf.noteOnOffNow (MINIM, 62, 50);
//		mf.noteOnOffNow (MINIM, 64, 50);
//		mf.noteOnOffNow (MINIM, 65, 50);
//		mf.noteOnOffNow (MINIM, 67, 50);
//		mf.noteOnOffNow (MINIM, 69, 50);
//		mf.noteOnOffNow (MINIM, 71, 50);
//		mf.noteOnOffNow (MINIM, 72, 50);
//		
